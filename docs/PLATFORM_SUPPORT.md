# 🌐 Платформенная поддержка SpectraForge
...
SpectraForge автоматически определяет платформу и отключает неподдерживаемые SDK:
...
**Поддержка:** Создайте issue на [GitHub](https://github.com/TiGRoNdev/SpectraForge/issues) если у вас возникли проблемы с платформенной поддержкой.
