...
```
SpectraForge Architecture v1.0.0
├── 🎯 Core Engine
│   ├── Math Library
│   │   ├── Vector3/Vector4
│   │   ├── Matrix4
...
Архитектура SpectraForge v1.0.0 обеспечивает:
