# 🇷🇺 Полное руководство по установке HyperEngine
...
HyperEngine - это современный гибридный 3D/4D движок рендеринга на основе Vulkan с поддержкой:
...
### Шаг 4: Клонирование HyperEngine
...
### В1: Можно ли собрать HyperEngine без NVIDIA GPU?
...
### В4: Работает ли HyperEngine на WSL2?
...
HyperEngine распространяется под лицензией [MIT License](LICENSE).

---

**Успешной работы с HyperEngine! 🚀**
