...
HyperEngine поддерживает сборку на Linux с некоторыми ограничениями, связанными с платформенной поддержкой SDK от производителей.
