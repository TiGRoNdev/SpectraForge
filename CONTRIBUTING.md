# Руководство по вкладу в проект 4D Game Engine

Спасибо за интерес к проекту 4D Game Engine! Мы приветствуем вклад от сообщества и ценим любую помощь в развитии движка.
...
1. Проверьте, не была ли уже сообщена эта ошибка в [Issues](https://github.com/yourusername/4d-engine/issues)
