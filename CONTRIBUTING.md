# Руководство по вкладу в проект SpectraForge

Спасибо за интерес к проекту SpectraForge! Мы приветствуем вклад от сообщества и ценим любую помощь в развитии современного 3D/4D игрового движка.
