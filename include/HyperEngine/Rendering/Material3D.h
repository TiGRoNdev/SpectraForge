...
class Material3D {
  ...
  public:
     ...
     */
    std::shared_ptr<Texture3D> getRoughnessMetallicTexture() const {
        return roughnessMetallicTexture;
    }
    void setRoughnessMetallicTexture(std::shared_ptr<Texture3D> texture) {
     ...
     */
    static std::shared_ptr<Material3D> createEmissive(const Math::Vector3& emissionColor,
                                                      const std::string& name = "Emissive");

    /**
     * @brief Создать прозрачный материал
     */
    static std::shared_ptr<Material3D> createTransparent(const Math::Vector3& color,
                                                         float alpha = 0.5f,
     ...
     */
    static std::shared_ptr<Material3D> createMetallic(const Math::Vector3& color,
