...
public:
    explicit RendererFactoryAdapter(
        RendererType preferredType = RendererType::Vulkan,
     ...
     */
    void setPreferredType(RendererType type) {
        preferredType_ = type;
    }
     ...
     */
    void setDefaultConfig(const RendererConfig& config) {
