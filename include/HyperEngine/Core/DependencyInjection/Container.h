...
private:
    ...
    public:
        ...
        Lifetime getLifetime() const override {
            return lifetime_;
        }
    };
...
public:
    ...
    void registerSingleton(std::function<std::shared_ptr<Interface>(Container&)> factory) {
        ...
        factories_[typeIndex] = std::make_unique<Factory<Interface>>(
            std::move(factory), Lifetime::Singleton);
    }
    ...
    void registerTransient(std::function<std::shared_ptr<Interface>(Container&)> factory) {
        ...
        auto typeIndex = std::type_index(typeid(Interface));
        factories_[typeIndex] = std::make_unique<Factory<Interface>>(
            std::move(factory), Lifetime::Transient);
    }
    ...
    void registerScoped(std::function<std::shared_ptr<Interface>(Container&)> factory) {
        ...
        auto typeIndex = std::type_index(typeid(Interface));
        factories_[typeIndex] = std::make_unique<Factory<Interface>>(
            std::move(factory), Lifetime::Scoped);
    }
    ...
    std::shared_ptr<Interface> resolve() {
        ...
        throw std::runtime_error("Неизвестный lifetime для типа " + std::string(typeid(Interface).name()));
    }
