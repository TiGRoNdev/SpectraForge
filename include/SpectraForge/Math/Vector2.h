...
class Vector2 {
  public:
    ...
    Vector2 lerp(const Vector2& other, float t) const { return *this + (other - *this) * t; }
    ...
    std::string toString() const {
        return "Vector2(" + SpectraForge::Core::SAFE_TO_STRING(x) + ", "
               + SpectraForge::Core::SAFE_TO_STRING(y) + ")";
    }
};
