...
protected:
    ...
    unsigned int linkProgram(unsigned int vertexShader, unsigned int fragmentShader, unsigned int geometryShader = 0);
...
public:
    ...
    std::shared_ptr<Shader3D> loadShader(const std::string& name, const std::string& vertexPath, const std::string& fragmentPath);
