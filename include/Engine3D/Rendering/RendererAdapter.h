...
public:
    ...
    // Рендеринг объектов
    virtual void renderMesh(const Mesh3D& mesh, const Math::Matrix4& transform, const Shader3D& shader) = 0;
    virtual void renderMesh(std::shared_ptr<Mesh3D> mesh, const Math::Matrix4& transform, std::shared_ptr<Shader3D> shader) = 0;
    virtual void renderWireframe(const Mesh3D& mesh, const Math::Matrix4& transform, const Shader3D& shader) = 0;
...
public:
    ...
    void renderMesh(std::shared_ptr<Mesh3D> mesh, const Math::Matrix4& transform, std::shared_ptr<Shader3D> shader);
    void renderWireframe(const Mesh3D& mesh, const Math::Matrix4& transform, const Shader3D& shader);
...
public:
    ...
    void renderMesh(const Mesh3D& mesh, const Math::Matrix4& transform, const Shader3D& shader) override;
    void renderMesh(std::shared_ptr<Mesh3D> mesh, const Math::Matrix4& transform, std::shared_ptr<Shader3D> shader) override;
    void renderWireframe(const Mesh3D& mesh, const Math::Matrix4& transform, const Shader3D& shader) override;
