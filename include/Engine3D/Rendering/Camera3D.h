...
public:
    ...
    void lookAt(const Math::Vector3& pos, const Math::Vector3& target, const Math::Vector3& up = Math::Vector3::up());
    ...
    Math::Vector3 screenToWorld(const Math::Vector3& screenPos, const Math::Vector3& screenSize) const;
    Math::Vector3 worldToScreen(const Math::Vector3& worldPos, const Math::Vector3& screenSize) const;
