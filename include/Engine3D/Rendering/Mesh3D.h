...
struct Vertex3D {
    ...
    Vertex3D(const Math::Vector3& pos, const Math::Vector3& norm = Math::Vector3(0.0f, 1.0f, 0.0f),
             const Math::Vector3& col = Math::Vector3(1.0f, 1.0f, 1.0f), float u = 0.0f, float v = 0.0f)
...
public:
    ...
    static std::shared_ptr<Mesh3D> createCylinder(float radius = 1.0f, float height = 2.0f, int segments = 32);
    static std::shared_ptr<Mesh3D> createCone(float radius = 1.0f, float height = 2.0f, int segments = 32);
