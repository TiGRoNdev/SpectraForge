...
public:
    ...
    struct CameraParams {
        ...
        CameraParams() : position(0, 0, 5), target(0, 0, 0), up(0, 1, 0),
                        fov(60.0f), aspectRatio(16.0f/9.0f), nearPlane(0.1f), farPlane(1000.0f),
                        viewDistance(5.0f), velocity(0, 0, 0), isMoving(false) {}
    };
...
public:
     ...
     */
    static std::unique_ptr<OptimalRenderer3D> createOptimalRenderer(const CreationParams& params = CreationParams{});
