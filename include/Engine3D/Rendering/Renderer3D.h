...
public:
    ...
    struct Light {
        ...
        Light() : type(DIRECTIONAL), position(0, 5, 0), direction(0, -1, 0), 
                 color(1, 1, 1), intensity(1.0f), range(10.0f), 
                 innerCone(30.0f), outerCone(45.0f), enabled(true) {}
    };
    ...
    struct RenderStats {
        ...
        void reset() { trianglesRendered = drawCalls = verticesProcessed = 0; frameTime = 0.0f; }
    };
