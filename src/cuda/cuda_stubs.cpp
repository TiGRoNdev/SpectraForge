...
void launchGaussianInitialization(const float4* positions,
                                  int numPoints,
                                  float4* gaussians,
                                  float3* colors,
                                  float* opacities,
...
void launchGradientComputation(const float4* positions,
                               const float4* colors,
...
void launchParameterUpdate(float4* positions,
                           float3* colors,
                           float* opacities,
                           float* scales,
...
void launchGaussianProjection(const float4* gaussians,
                              const float* scales,
    ...
    (void)viewMatrix;
    (void)projMatrix;
    (void)projectedGaussians;
    (void)depths;
    (void)tileAssignments;
    (void)numGaussians;
    (void)screenWidth;
    (void)screenHeight;
}

void launchTileAssignment(const float4* projectedGaussians,
                          const float* depths,
                          int* tileAssignments,
                          int* gaussianIndices,
                          int numGaussians,
    ...
    (void)depths;
    (void)tileAssignments;
    (void)gaussianIndices;
    (void)numGaussians;
    (void)numTiles;
}

void launchTileRasterization(const float4* projectedGaussians,
                             const float3* colors,
...
void launchCubRadixSort(float* keys,
                        int* values,
                        int numElements,
                        void* tempStorage,
